...
Gui, 2:Add, Text,x5 h20, ForceLogoutAlt:
...
Gui, 2:Add, Hotkey, w150 h20 vguihotkeySuperLogoutAlt , %hotkeySuperLogoutAlt%
...
submit(){  
	...
	IniWrite, %guihotkeySuperLogoutAlt%, settings.ini, hotkeys, superLogoutAlt
...
readFromFile(){
	...
	IniRead, hotkeySuperLogoutAlt, settings.ini, hotkeys, superLogoutAlt, %A_Space%
	...
	If hotkeySuperLogoutAlt
		Hotkey,% hotkeySuperLogoutAlt, superLogoutCommand, On
	If hotkeySuperLogout
